...
/**
 * Created by zhangjian on 2019/6/12 16:05
 */
...
//        mPaint.setColorFilter(new LightingColorFilter(0xffffff, 0x000090)); //设置颜色过滤器
//        mPaint.setColorFilter(new PorterDuffColorFilter(Color.GREEN, PorterDuff.Mode.SRC_OVER)); //设置颜色过滤器
...
//        float v = mPaint.measureText(str);//获取文本的宽
//        Paint.FontMetrics fontMetrics = mPaint.getFontMetrics();//获取字体度量对象
//        Log.e("onDraw", "onDraw" + "text width = " + v + ",fontMetrics = " + fontMetrics.toString());
    }
...
//         */
//        mShader = new LinearGradient(0, 0, 100, 100, new int[]{Color.RED, Color.BLUE, Color.GREEN}, new float[]{0.f,0.7f,1}, Shader.TileMode.REPEAT);
